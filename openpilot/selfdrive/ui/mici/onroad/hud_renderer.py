...
class HudRenderer(Widget):
  ...
  def _draw_steering_wheel(self, rect: rl.Rectangle) -> None:
    ...
    if gui_app.sunnypilot_ui() and sm.seen['longitudinalPlanSP'] and sm['longitudinalPlanSP'].dec.active:
      dec_state = sm['longitudinalPlanSP'].dec.state
      blended = custom.LongitudinalPlanSP.DynamicExperimentalControl.DynamicExperimentalControlState.blended
      experimental_mode = experimental_mode and dec_state == blended
